...
export class Legend {
  ...
  draw(): void {
    ...
    for (let line of this.lines) {
      ...
      l.style["margin-top"] = "3px";
      l.style["margin-bottom"] = "3px";
      l.style["font-size"] = "12";
...
export class Plot {
  ...
  constructor(wrapperDiv: HTMLDivElement) {
    ...
    this.legendDiv.style["z-index"] = 1;
    this.legendDiv.style["pointer-events"] = "none";
    ...
    this.textCanvas.style["pointer-events"] = "none";
    ...
    this.draw();
    console.log(this.textCanvas.parentElement);
  }
  ...
  draw() {
    ...
    //console.log(this.textCanvas.style.width);
